...
RTByTrial2A = aggregate((1*(resAll2A$RTDV))~resAll2A$trial,FUN=mean)
RTByTrial2B = aggregate(( 1*(resAll2B$RTDV))~resAll2B$trial,FUN=mean)

plot(RTByTrial2A, main="Mean RT across trials in Exp 1A",
     xlab = "Trial number", ylab = "Response Time")
#abline(lm(resAll2A$RTDV~resAll2A$trial), col="red") # regression line (y~x) 

plot(RTByTrial2B, main="Mean RT across trials in Exp 1B",
     xlab = "Trial number", ylab = "Response Time")
#abline(lm(resAll2A$RTDV~resAll2A$trial), col="red") # regression line (y~x) 
